...
export default async function BoardOfDirectionPage() {
  ...
  const breadcrumbItems = [
    ...
    { label: "Ban lãnh đạo", href: "/org/board-of-direction" }
  ];
  ...
  const leadership = {
    director: {
      ...
      description:
        "Giáo Sư, Tiến sĩ Dương Văn Sinh là Giám đốc Chi nhánh RIDES-HCM (Chi nhánh Viện Nghiên cứu Thiên tai và Môi trường tại Thành phố Hồ Chí Minh), đồng thời là Chủ tịch Hội đồng Khoa học Viện Nghiên cứu Thiên tai và Môi trường."
    },
    deputyDirectors: [
      {
        ...
        position: "Viện phó",
        description:
          "Phó Giáo Sư, Tiến sĩ Nguyễn Đăng Nam là Phó Viện trưởng và Trưởng nhóm Phòng thí nghiệm Vật liệu và Linh kiện tương lai."
      },
      {
        name: "Võ Nguyên Sơn",
        degree: "TS",
        position: "Viện phó",
        description:
          "Tiến sĩ Võ Nguyên Sơn là Phó Viện trưởng và Trưởng nhóm ICT (Công nghệ thông tin và Truyền thông)."
      }
    ]
  };
        ...
        <div className="flex flex-col lg:flex-row gap-8 mt-8">
          ...
          <main className="flex-1">
              ...
              <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className="flex-1">
                  <div className="mb-4">
                    ...
                    <h2 className="text-3xl font-bold text-gray-800 mb-2">{leadership.director.name}</h2>
                    <p className="text-xl text-blue-600 font-semibold mb-4">{leadership.director.degree}</p>
                  </div>
                  <p className="text-gray-700 leading-relaxed">{leadership.director.description}</p>
                </div>
              </div>
            </div>
                  ...
                  >
                    <div className="flex flex-col items-center text-center mb-4">
                      <div className="w-32 h-32 bg-gradient-to-br from-green-500 to-green-700 rounded-full flex items-center justify-center mb-4">
                        <span className="text-4xl font-bold text-white">{deputy.name.charAt(0)}</span>
                      </div>
                      <span className="inline-block bg-green-100 text-green-800 text-xs font-semibold px-3 py-1 rounded-full mb-2">
                        {deputy.position}
                      </span>
                      <h3 className="text-2xl font-bold text-gray-800 mb-2">{deputy.name}</h3>
                      <p className="text-lg text-green-600 font-semibold mb-4">{deputy.degree}</p>
                    </div>
                    <p className="text-gray-700 leading-relaxed text-sm">{deputy.description}</p>
                  </div>
                ))}
              </div>
            </div> */}
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              <h2 className="text-2xl font-bold mb-4 text-gray-800">Thông tin liên hệ</h2>
              <div className="space-y-3 text-gray-700">
                ...
                <p>
                  Số 38, đường D15A, Khu nhà ở liên kế Hưng Phú (mở rộng), Phường Phước Long, Thành phố Thủ
                ...
                <p>
                  <strong>Email:</strong>{" "}
                  <a href="mailto:ifas.hcm@duytan.edu.vn" className="text-blue-600 hover:text-blue-800">
