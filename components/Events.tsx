export default function Events() {
  ...
  return (
    <section className="container">
      <h2 className="text-2xl md:text-3xl font-bold mb-6 text-gray-800 text-left">Sự kiện</h2>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {events.map((event, index) => (
          ...
          >
            ...
            <h3 className="text-lg font-semibold mb-4 text-gray-800 leading-relaxed">{event.title}</h3>
